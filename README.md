...
| **Kalshi 15M** | Kalshi gold/silver/copper/WTI/natgas + BTC binaries | **LIVE canary 24/7** — $250 `desk_book` (commodities 8% ≥60¢ until close; BTC 4% ≥72¢ skip last 2 min; ETH off); see `docs/KALSHI_15M.md` |
