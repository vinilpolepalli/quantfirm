...
| **Kalshi 15M** | Kalshi gold/silver/copper/WTI/natgas + BTC/ETH binaries | **LIVE canary 24/7** — $250 `desk_book` (commodities 8% ≥60¢ until close; BTC and ETH 4% ≥72¢ until close); see `docs/KALSHI_15M.md` |
