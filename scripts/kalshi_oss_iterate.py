...
After 2026-09-12 the live desk_book bar is 75¢ after the 3 min wait.
desk_book and richer_wait (68¢ alias) no longer match. The @60 rows in
research/kalshi_oss.md are the prior live book.
"""
