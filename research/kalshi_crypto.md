...
## Live overlay moved 60¢ → 68¢ → 75¢ (2026-09-12 evening)

Owner: win on both names even if they differ; keep testing bars and
waits. 1¢ × wait sweep on the mixed book (~2 weeks of 15m crypto, not
months): wait3+60 BTC −$100 / ETH −$62; wait3+68 +$23 / +$8;
wait3+**75¢** **+$80 / +$20**. 74¢ dumps ETH. No-wait 79¢ looks strong
on ALL but weekend ETH is still red. Keep the 3 min wait. Names
independent. Numbers: `research/kalshi_bar.md`.
