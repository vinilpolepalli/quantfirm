...
* 2026-09-12T01:04Z (auto check-in). Maker +52.24 (4 fills, 3/4 won). Taker +35.09 (4). **Cumulative maker +203.68 (130 fills, hit 0.700 vs break-even 0.660, cushion +3.98pp, t=0.88).** t-history: 0.94 → 1.22 → 1.2 → 1.5 → 0.67 → 0.88.

* 2026-09-12T02:04Z (auto check-in). Maker -150.67 (5 fills, 0/5 won). Taker -75.81 (3). **Cumulative maker +53.01 (135 fills, hit 0.674 vs break-even 0.664, cushion +0.99pp, t=0.22).** t-history: 1.22 → 1.2 → 1.5 → 0.67 → 0.88 → 0.22.

* 2026-09-12T03:04Z (auto check-in). Taker +59.74 (4). **Cumulative maker +53.01 (135 fills, hit 0.674 vs break-even 0.664, cushion +0.99pp, t=0.22).** t-history: 1.22 → 1.2 → 1.5 → 0.67 → 0.88 → 0.22.

* 2026-09-12T04:04Z (auto check-in). Taker -8.74 (4). **Cumulative maker +53.01 (135 fills, hit 0.674 vs break-even 0.664, cushion +0.99pp, t=0.22).** t-history: 1.22 → 1.2 → 1.5 → 0.67 → 0.88 → 0.22.

* 2026-09-14T00:05Z (auto check-in). Maker +4.50 (1 fills, 1/1 won). Taker +14.98 (2). **Cumulative maker +57.51 (136 fills, hit 0.676 vs break-even 0.666, cushion +1.06pp, t=0.24).** t-history: 1.2 → 1.5 → 0.67 → 0.88 → 0.22 → 0.24.

* 2026-09-14T02:05Z (auto check-in). Maker +15.13 (2 fills, 2/2 won). Taker +8.05 (1). **Cumulative maker +72.64 (138 fills, hit 0.681 vs break-even 0.668, cushion +1.33pp, t=0.30).** t-history: 1.5 → 0.67 → 0.88 → 0.22 → 0.24 → 0.3.

* 2026-09-14T03:05Z (auto check-in). Maker -3.92 (2 fills, 1/2 won). Taker +9.22 (1). **Cumulative maker +68.72 (140 fills, hit 0.679 vs break-even 0.666, cushion +1.25pp, t=0.28).** t-history: 0.67 → 0.88 → 0.22 → 0.24 → 0.3 → 0.28.

* 2026-09-14T04:05Z (auto check-in). Maker +14.37 (2 fills, 2/2 won). Taker +8.29 (1). **Cumulative maker +83.09 (142 fills, hit 0.683 vs break-even 0.668, cushion +1.49pp, t=0.34).** t-history: 0.88 → 0.22 → 0.24 → 0.3 → 0.28 → 0.34.

* 2026-09-14T05:05Z (auto check-in). Maker -29.19 (2 fills, 0/2 won). Taker +14.44 (1). **Cumulative maker +53.90 (144 fills, hit 0.674 vs break-even 0.664, cushion +0.97pp, t=0.22).** t-history: 0.22 → 0.24 → 0.3 → 0.28 → 0.34 → 0.22.

* 2026-09-14T06:06Z (auto check-in). Maker -7.09 (2 fills, 1/2 won). Taker +11.80 (1). **Cumulative maker +46.81 (146 fills, hit 0.671 vs break-even 0.663, cushion +0.83pp, t=0.19).** t-history: 0.24 → 0.3 → 0.28 → 0.34 → 0.22 → 0.19.

* 2026-09-14T07:05Z (auto check-in). Maker +3.77 (1 fills, 1/1 won). **Cumulative maker +50.58 (147 fills, hit 0.673 vs break-even 0.664, cushion +0.90pp, t=0.21).** t-history: 0.3 → 0.28 → 0.34 → 0.22 → 0.19 → 0.21.

* 2026-09-14T08:06Z (auto check-in). Maker -45.36 (2 fills, 0/2 won). Taker -2.92 (2). **Cumulative maker +5.22 (149 fills, hit 0.664 vs break-even 0.663, cushion +0.09pp, t=0.02).** t-history: 0.28 → 0.34 → 0.22 → 0.19 → 0.21 → 0.02.

* 2026-09-14T09:05Z (auto check-in). Taker +4.34 (1). **Cumulative maker +5.22 (149 fills, hit 0.664 vs break-even 0.663, cushion +0.09pp, t=0.02).** t-history: 0.28 → 0.34 → 0.22 → 0.19 → 0.21 → 0.02.

* 2026-09-14T10:06Z (auto check-in). Taker -29.00 (1). **Cumulative maker +5.22 (149 fills, hit 0.664 vs break-even 0.663, cushion +0.09pp, t=0.02).** t-history: 0.28 → 0.34 → 0.22 → 0.19 → 0.21 → 0.02.

* 2026-09-14T11:05Z (auto check-in). Taker -27.81 (1). **Cumulative maker +5.22 (149 fills, hit 0.664 vs break-even 0.663, cushion +0.09pp, t=0.02).** t-history: 0.28 → 0.34 → 0.22 → 0.19 → 0.21 → 0.02.

* 2026-09-14T12:06Z (auto check-in). Taker +17.71 (2). **Cumulative maker +5.22 (149 fills, hit 0.664 vs break-even 0.663, cushion +0.09pp, t=0.02).** t-history: 0.28 → 0.34 → 0.22 → 0.19 → 0.21 → 0.02.

* 2026-09-14T14:06Z (auto check-in). Taker -10.65 (2). **Cumulative maker +5.22 (149 fills, hit 0.664 vs break-even 0.663, cushion +0.09pp, t=0.02).** t-history: 0.28 → 0.34 → 0.22 → 0.19 → 0.21 → 0.02.

* 2026-09-14T15:07Z (auto check-in). Taker -8.33 (2). **Cumulative maker +5.22 (149 fills, hit 0.664 vs break-even 0.663, cushion +0.09pp, t=0.02).** t-history: 0.28 → 0.34 → 0.22 → 0.19 → 0.21 → 0.02.
...
* 2026-09-14T20:05Z (auto check-in). Taker +10.32 (1). **Cumulative maker -19.26 (151 fills, hit 0.656 vs break-even 0.659, cushion -0.34pp, t=-0.08).** t-history: 0.34 → 0.22 → 0.19 → 0.21 → 0.02 → -0.08.

* 2026-09-14T21:04Z (auto check-in). Taker +5.09 (1). **Cumulative maker -19.26 (151 fills, hit 0.656 vs break-even 0.659, cushion -0.34pp, t=-0.08).** t-history: 0.34 → 0.22 → 0.19 → 0.21 → 0.02 → -0.08.

* 2026-09-15T00:04Z (auto check-in). Taker +16.50 (1). **Cumulative maker -19.26 (151 fills, hit 0.656 vs break-even 0.659, cushion -0.34pp, t=-0.08).** t-history: 0.34 → 0.22 → 0.19 → 0.21 → 0.02 → -0.08.

* 2026-09-15T01:05Z (auto check-in). Maker +11.14 (2 fills, 2/2 won). Taker +4.51 (1). **Cumulative maker -8.12 (153 fills, hit 0.660 vs break-even 0.661, cushion -0.14pp, t=-0.03).** t-history: 0.22 → 0.19 → 0.21 → 0.02 → -0.08 → -0.03.

* 2026-09-15T02:05Z (auto check-in). Maker +8.76 (2 fills, 2/2 won). Taker +6.04 (1). **Cumulative maker +0.64 (155 fills, hit 0.664 vs break-even 0.664, cushion +0.01pp, t=0.00).** t-history: 0.19 → 0.21 → 0.02 → -0.08 → -0.03 → 0.0.

* 2026-09-15T03:04Z (auto check-in). Maker +17.92 (2 fills, 2/2 won). Taker +8.29 (1). **Cumulative maker +18.56 (157 fills, hit 0.669 vs break-even 0.666, cushion +0.32pp, t=0.07).** t-history: 0.21 → 0.02 → -0.08 → -0.03 → 0.0 → 0.07.

* 2026-09-15T04:05Z (auto check-in). Maker +18.88 (2 fills, 2/2 won). Taker +10.84 (1). **Cumulative maker +37.44 (159 fills, hit 0.673 vs break-even 0.667, cushion +0.63pp, t=0.15).** t-history: 0.02 → -0.08 → -0.03 → 0.0 → 0.07 → 0.15.

* 2026-09-15T05:05Z (auto check-in). Maker +17.85 (2 fills, 2/2 won). Taker +16.42 (1). **Cumulative maker +55.29 (161 fills, hit 0.677 vs break-even 0.668, cushion +0.92pp, t=0.22).** t-history: -0.08 → -0.03 → 0.0 → 0.07 → 0.15 → 0.22.

* 2026-09-15T06:05Z (auto check-in). Maker +8.10 (1 fills, 1/1 won). Taker +11.41 (1). **Cumulative maker +63.39 (162 fills, hit 0.679 vs break-even 0.668, cushion +1.05pp, t=0.25).** t-history: -0.03 → 0.0 → 0.07 → 0.15 → 0.22 → 0.25.

* 2026-09-15T07:05Z (auto check-in). Maker +10.66 (1 fills, 1/1 won). **Cumulative maker +74.05 (163 fills, hit 0.681 vs break-even 0.669, cushion +1.22pp, t=0.30).** t-history: 0.0 → 0.07 → 0.15 → 0.22 → 0.25 → 0.3.

* 2026-09-15T08:05Z (auto check-in). Maker +7.48 (1 fills, 1/1 won). **Cumulative maker +81.53 (164 fills, hit 0.683 vs break-even 0.670, cushion +1.34pp, t=0.33).** t-history: 0.07 → 0.15 → 0.22 → 0.25 → 0.3 → 0.33.

* 2026-09-15T10:04Z (auto check-in). Maker +12.58 (2 fills, 2/2 won). Taker +5.12 (1). **Cumulative maker +94.11 (166 fills, hit 0.687 vs break-even 0.671, cushion +1.53pp, t=0.38).** t-history: 0.15 → 0.22 → 0.25 → 0.3 → 0.33 → 0.38.

* 2026-09-15T12:05Z (auto check-in). Maker -27.56 (1 fills, 0/1 won). **Cumulative maker +66.55 (167 fills, hit 0.683 vs break-even 0.672, cushion +1.07pp, t=0.26).** t-history: 0.22 → 0.25 → 0.3 → 0.33 → 0.38 → 0.26.

* 2026-09-15T12:17Z (auto check-in). Maker +20.30 (2 fills, 2/2 won). Taker +14.69 (1). **Cumulative maker +86.85 (169 fills, hit 0.686 vs break-even 0.672, cushion +1.39pp, t=0.34).** t-history: 0.25 → 0.3 → 0.33 → 0.38 → 0.26 → 0.34.

* 2026-09-15T14:05Z (auto check-in). Maker +22.28 (2 fills, 2/2 won). Taker +15.81 (1). **Cumulative maker +109.13 (171 fills, hit 0.690 vs break-even 0.673, cushion +1.72pp, t=0.43).** t-history: 0.3 → 0.33 → 0.38 → 0.26 → 0.34 → 0.43.

* 2026-09-15T15:05Z (auto check-in). Maker +20.83 (2 fills, 2/2 won). Taker +12.68 (1). **Cumulative maker +129.96 (173 fills, hit 0.694 vs break-even 0.673, cushion +2.03pp, t=0.51).** t-history: 0.33 → 0.38 → 0.26 → 0.34 → 0.43 → 0.51.

* 2026-09-15T16:05Z (auto check-in). Maker +25.33 (3 fills, 3/3 won). Taker -16.29 (3). **Cumulative maker +155.29 (176 fills, hit 0.699 vs break-even 0.675, cushion +2.39pp, t=0.61).** t-history: 0.38 → 0.26 → 0.34 → 0.43 → 0.51 → 0.61.

* 2026-09-15T17:04Z (auto check-in). Maker -1.72 (4 fills, 3/4 won). Taker +17.22 (2). **Cumulative maker +153.57 (180 fills, hit 0.700 vs break-even 0.677, cushion +2.30pp, t=0.60).** t-history: 0.26 → 0.34 → 0.43 → 0.51 → 0.61 → 0.6.

* 2026-09-15T18:04Z (auto check-in). Maker -58.75 (7 fills, 3/7 won). Taker +21.97 (3). **Cumulative maker +94.82 (187 fills, hit 0.695 vs break-even 0.681, cushion +1.36pp, t=0.36).** t-history: 0.34 → 0.43 → 0.51 → 0.61 → 0.6 → 0.36.

* 2026-09-15T19:04Z (auto check-in). Maker +5.83 (2 fills, 1/2 won). Taker +18.80 (1). **Cumulative maker +100.65 (189 fills, hit 0.693 vs break-even 0.679, cushion +1.43pp, t=0.38).** t-history: 0.43 → 0.51 → 0.61 → 0.6 → 0.36 → 0.38.

* 2026-09-15T20:05Z (auto check-in). Maker +6.75 (1 fills, 1/1 won). Taker +6.05 (1). **Cumulative maker +107.40 (190 fills, hit 0.695 vs break-even 0.679, cushion +1.52pp, t=0.41).** t-history: 0.51 → 0.61 → 0.6 → 0.36 → 0.38 → 0.41.

* 2026-09-15T21:04Z (auto check-in). Maker -5.96 (2 fills, 1/2 won). **Cumulative maker +101.44 (192 fills, hit 0.693 vs break-even 0.678, cushion +1.43pp, t=0.38).** t-history: 0.61 → 0.6 → 0.36 → 0.38 → 0.41 → 0.38.

* 2026-09-15T22:05Z (auto check-in). Maker +9.60 (1 fills, 1/1 won). **Cumulative maker +111.04 (193 fills, hit 0.694 vs break-even 0.679, cushion +1.55pp, t=0.42).** t-history: 0.6 → 0.36 → 0.38 → 0.41 → 0.38 → 0.42.

* 2026-09-15T23:21Z (auto check-in). Maker -13.82 (2 fills, 1/2 won). Taker -32.81 (2). **Cumulative maker +97.22 (195 fills, hit 0.692 vs break-even 0.679, cushion +1.35pp, t=0.36).** t-history: 0.36 → 0.38 → 0.41 → 0.38 → 0.42 → 0.36.

* 2026-09-16T00:04Z (auto check-in). Maker -5.75 (3 fills, 2/3 won). Taker +60.95 (1). **Cumulative maker +91.47 (198 fills, hit 0.692 vs break-even 0.679, cushion +1.25pp, t=0.34).** t-history: 0.38 → 0.41 → 0.38 → 0.42 → 0.36 → 0.34.

* 2026-09-16T01:04Z (auto check-in). Maker +53.68 (3 fills, 3/3 won). Taker +32.95 (3). **Cumulative maker +145.15 (201 fills, hit 0.697 vs break-even 0.677, cushion +1.95pp, t=0.54).** t-history: 0.41 → 0.38 → 0.42 → 0.36 → 0.34 → 0.54.

* 2026-09-16T02:05Z (auto check-in). Maker +0.20 (3 fills, 2/3 won). Taker +7.47 (1). **Cumulative maker +145.35 (204 fills, hit 0.696 vs break-even 0.677, cushion +1.93pp, t=0.54).** t-history: 0.41 → 0.38 → 0.42 → 0.36 → 0.34 → 0.54.

* 2026-09-16T03:05Z (auto check-in). Maker +36.87 (3 fills, 3/3 won). Taker +29.41 (2). **Cumulative maker +182.22 (207 fills, hit 0.701 vs break-even 0.677, cushion +2.38pp, t=0.67).** t-history: 0.38 → 0.42 → 0.36 → 0.34 → 0.54 → 0.67.

* 2026-09-16T04:05Z (auto check-in). Maker +25.97 (3 fills, 3/3 won). Taker +22.94 (3). **Cumulative maker +208.19 (210 fills, hit 0.705 vs break-even 0.678, cushion +2.69pp, t=0.76).** t-history: 0.42 → 0.36 → 0.34 → 0.54 → 0.67 → 0.76.

* 2026-09-16T05:07Z (auto check-in). Maker +10.93 (4 fills, 3/4 won). Taker +55.66 (3). **Cumulative maker +219.12 (214 fills, hit 0.706 vs break-even 0.678, cushion +2.76pp, t=0.79).** t-history: 0.36 → 0.34 → 0.54 → 0.67 → 0.76 → 0.79.

* 2026-09-16T05:16Z (auto check-in). Maker -7.31 (5 fills, 3/5 won). Taker -99.13 (3). **Cumulative maker +211.81 (219 fills, hit 0.703 vs break-even 0.678, cushion +2.52pp, t=0.72).** t-history: 0.34 → 0.54 → 0.67 → 0.76 → 0.79 → 0.72.

* 2026-09-16T07:05Z (auto check-in). Maker -25.30 (2 fills, 1/2 won). Taker +9.06 (1). **Cumulative maker +186.51 (221 fills, hit 0.701 vs break-even 0.679, cushion +2.19pp, t=0.59).** t-history: 0.67 → 0.76 → 0.79 → 0.72 → 0.67 → 0.59.

* 2026-09-16T08:04Z (auto check-in). Maker -5.86 (2 fills, 1/2 won). Taker -24.56 (2). **Cumulative maker +180.65 (223 fills, hit 0.700 vs break-even 0.678, cushion +2.11pp, t=0.57).** t-history: 0.76 → 0.79 → 0.72 → 0.67 → 0.59 → 0.57.

* 2026-09-16T08:47Z (auto check-in). Maker +21.16 (2 fills, 2/2 won). Taker +9.32 (1). **Cumulative maker +201.81 (225 fills, hit 0.702 vs break-even 0.679, cushion +2.34pp, t=0.64).** t-history: 0.79 → 0.72 → 0.67 → 0.59 → 0.57 → 0.64.

* 2026-09-16T10:05Z (auto check-in). Maker +32.15 (2 fills, 2/2 won). Taker +43.24 (2). **Cumulative maker +233.96 (227 fills, hit 0.705 vs break-even 0.678, cushion +2.69pp, t=0.74).** t-history: 0.72 → 0.67 → 0.59 → 0.57 → 0.64 → 0.74.

* 2026-09-16T10:51Z (auto check-in). Maker -23.10 (2 fills, 1/2 won). Taker -41.12 (1). **Cumulative maker +210.86 (229 fills, hit 0.703 vs break-even 0.679, cushion +2.39pp, t=0.66).** t-history: 0.67 → 0.59 → 0.57 → 0.64 → 0.74 → 0.66.

* 2026-09-16T12:06Z (auto check-in). Maker -21.21 (2 fills, 1/2 won). Taker -38.81 (1). **Cumulative maker +189.65 (231 fills, hit 0.701 vs break-even 0.680, cushion +2.13pp, t=0.59).** t-history: 0.59 → 0.57 → 0.64 → 0.74 → 0.66 → 0.59.

* 2026-09-16T12:47Z (auto check-in). Maker -30.17 (4 fills, 2/4 won). **Cumulative maker +159.48 (235 fills, hit 0.698 vs break-even 0.680, cushion +1.77pp, t=0.49).** t-history: 0.57 → 0.64 → 0.74 → 0.66 → 0.59 → 0.49.

* 2026-09-16T14:05Z (auto check-in). Maker -19.66 (2 fills, 1/2 won). Taker +6.47 (1). **Cumulative maker +139.82 (237 fills, hit 0.696 vs break-even 0.681, cushion +1.54pp, t=0.43).** t-history: 0.64 → 0.74 → 0.66 → 0.59 → 0.49 → 0.43.
