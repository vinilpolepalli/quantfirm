...
BTC and ETH 4% / ≥75¢ and sit if Poly disagrees). All seven names can
clip. Live IOC under 4 lots is skipped (not a 1¢ clip). Maker off.
...
each (~$9–10) / ≥75¢ / after T+3**. BTC and ETH are independent books —
they do **not** have to agree. Coin-flips and 60–74¢ still sit. Do not
raise 75¢ — live 78¢+ is red.
...
All seven names can clip in the same window. 24/7 wiring is in
...
disagrees (missing Poly does not sit). All seven names can clip — BTC
YES and ETH NO in the same window is allowed, and gold+silver can both
be on.
...
the wait-3 peak. Live 78¢+ is red so the bar stays 75¢. Weekend ETH is
still the hole. Numbers: `research/kalshi_bar.md`. Sweep:
...
| `rich_fav` / `desk_book` | Wait 3; 8% / 4% / ≥75¢ + Poly; all 7 names | Open flicker; skip 99¢ and sub-4-lot dust |
